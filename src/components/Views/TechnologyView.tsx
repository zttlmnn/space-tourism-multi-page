...
const TechnologyView: FC<{technologyData: TechnologyData[]}> = props => {
  ...
  const cssBtnStyle = [styles['technology-view__btn'], styles['technology-view__btn--active']]


  return (

    <div className={styles['technology-view']}>
      <div className={styles['technology-view__intro']}>
      <span>03</span>
      ...
      <div className={styles['technology-view__btns']}>
        <button onClick={technologyChangeHandler.bind(null, 0)} className={technology === 0 ? cssBtnStyle.join(' ') : cssBtnStyle[0]}>1</button>
        <button onClick={technologyChangeHandler.bind(null, 1)} className={technology === 1 ? cssBtnStyle.join(' ') : cssBtnStyle[0]}>2</button>
        <button onClick={technologyChangeHandler.bind(null, 2)} className={technology === 2 ? cssBtnStyle.join(' ') : cssBtnStyle[0]}>3</button>
      </div>
